...
//         {/* Background Elements */}
//         <View className="absolute inset-0">
//           <View className="absolute inset-0 bg-gradient-to-br from-gray-950 via-slate-900 to-gray-950" />
//           <View className="absolute rounded-full top-20 -left-20 w-80 h-80 bg-red-500/10 blur-3xl" />
//           <View className="absolute rounded-full bottom-40 -right-20 w-96 h-96 bg-yellow-500/10 blur-3xl" />
//         </View>
...
//               <View className="w-16 h-1 mb-6 bg-red-500 rounded-full" />
//               <Text className="mb-2 text-4xl font-black tracking-tight text-white">
//                 Welcome Back
//               </Text>
//               <Text className="max-w-xs text-base text-center text-white/60">
...
//               {/* Gym Icon */}
//               <View className="items-center justify-center w-20 h-20 mt-6 border rounded-full bg-red-500/10 border-red-500/20">
...
//               {/* Forgot Password */}
//               <TouchableOpacity className="items-end">
//                 <Text className="text-sm font-medium text-red-400 underline">
//                   Forgot Password?
//                 </Text>
//               </TouchableOpacity>
//             </Animated.View>
...
//             <TouchableOpacity
//               className={`w-full py-4 rounded-2xl mb-8 ${
//                 isLoadingLogin ? "bg-gray-600" : "bg-red-600"
//               }`}
//               onPress={handleLogin}
//               disabled={isLoadingLogin}
//               style={{
...
//               <Text className="text-base text-white/70">
//                 Don’t have an account?{" "}
//                 <Text className="font-semibold text-red-400 underline">
//                   Join Now
//                 </Text>
//               </Text>
//             </Pressable>
...
//             <View className="items-center p-4 mt-8 border bg-white/5 rounded-2xl border-white/10">
//               <Text className="text-sm leading-5 text-center text-white/60">
//                 🛡️ Your fitness progress is securely stored and protected
//               </Text>
//             </View>
//           </View>
//         </ScrollView>
...
//         {/* Edge Lighting */}
//         <View className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-red-500/50 to-transparent" />
//       </KeyboardAvoidingView>
//     </>
//   );
// };
